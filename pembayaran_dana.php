...
<body>
  ...
  <div class="container">
    ...
    <h1>Silahkan lakukan pembayaran melalui aplikasi DANA :</h1>
    ...
    <table class="payment-steps">
        ...
        <tr>
            <td>Step 1</td>
            <td>Buka aplikasi DANA di ponsel Anda</td>
        </tr>
        <tr>
            <td>Step 2</td>
            <td>Pilih menu "Bayar" pada halaman utama</td>
        </tr>
        <tr>
            <td>Step 3</td>
    ...
    <a href="pembayaran_selesai.php?total=<?php echo ($_GET['total']) ?>&metode=DANA"><button style="padding:5px;width:50%">Selesaikan Pembayaran</button></a>
</section>
