...
<body>
  ...
  <div class="container">
    ...
    <h1>Silahkan lakukan pembayaran melalui aplikasi GoPay :</h1>
    ...
    <table class="payment-steps">
        ...
        <tr>
            <td>Step 1</td>
            <td>Buka aplikasi Gojek dan masuk ke GoPay</td>
        </tr>
        <tr>
            <td>Step 2</td>
            <td>Pilih menu "Bayar" atau "Scan QR"</td>
        </tr>
        <tr>
            <td>Step 3</td>
            <td>Scan kode QR atau masukkan nomor tujuan</td>
        </tr>
        <tr>
            <td>Step 4</td>
        ...
        <tr>
            <td>Step 5</td>
            <td>Konfirmasi dan tekan "Lanjut"</td>
        </tr>
        <tr>
            <td>Step 6</td>
    ...
    <a href="pembayaran_selesai.php?total=<?php echo ($_GET['total']) ?>&metode=GoPay"><button style="padding:5px;width:50%">Selesaikan Pembayaran</button></a>
